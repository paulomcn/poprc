    ...
    public void enviarMensagemAlerta(String numeroDestino, String mensagem) {
        ...
        try {
            ...
            if (response.getStatusCode().is2xxSuccessful()) {
                ...
                System.err.println("⚠️ Gateway do WhatsApp aceitou a chamada, mas retornou status: " + response.getStatusCode());
            }
            
        } catch (Exception e) {
            // Tratamento robusto de exceção para a sua aplicação não crashar se a API do Zap cair
